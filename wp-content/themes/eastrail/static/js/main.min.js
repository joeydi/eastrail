...
function debounce(o,r){var e;return function(){var n=this,t=arguments;clearTimeout(e),e=setTimeout(function(){o.apply(n,t)},r)}}function throttle(r,e,a){var i,u;return e=void 0!==e?e:250,function(){var n=a||this,t=+new Date,o=arguments;i&&t<i+e?(clearTimeout(u),u=setTimeout(function(){i=t,r.apply(n,o)},e)):(i=t,r.apply(n,o))}}var scale=function(n){var t=n.domain[0],o=n.domain[1],r=n.range[0],e=n.range[1];return function(n){return r+(n-t)/(o-t)*(e-r)}};function convertRange(n,t,o){return(n-t[0])*(o[1]-o[0])/(t[1]-t[0])+o[0]}function precisionRound(n,t){t=Math.pow(10,t);return Math.round(n*t)/t}function getRandom(n,t){return Math.random()*(t-n)+n}function getRandomInt(n,t){return n=Math.ceil(n),t=Math.floor(t),Math.floor(Math.random()*(t-n+1))+n}function popupwindow(n,t,o,r){var e=window.outerWidth/2+window.screenX-o/2,a=window.outerHeight/2+window.screenY-r/2;return window.open(n,t,"toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width="+o+", height="+r+", top="+a+", left="+e)}function getUrlParameter(n){n=n.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");n=new RegExp("[\\?&]"+n+"=([^&#]*)").exec(location.search);return null===n?"":decodeURIComponent(n[1].replace(/\+/g," "))}function getUrlArrayParameter(n){for(var t=[],o=decodeURIComponent(window.location.search.substring(1)).split("&"),r=0;r<o.length;r++){var e=o[r].split("=");e[0].substring(0,e[0].indexOf("["))==n&&t.push(e[1])}return t}function guid(){function n(){return(65536*(1+Math.random())|0).toString(16).substring(1)}return n()+n()+"-"+n()+"-"+n()+"-"+n()+"-"+n()+n()+n()}function makeid(n){for(var t="",o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",r=o.length,e=0;e<n;e++)t+=o.charAt(Math.floor(Math.random()*r));return t}
var $=$||jQuery,ET=ET||{};gsap.registerPlugin(DrawSVGPlugin,ScrollTrigger,SplitText),ET.mq={xs:"(min-width: 375px)",sm:"(min-width: 576px)",md:"(min-width: 768px)",lg:"(min-width: 992px)",xl:"(min-width: 1200px)",xxl:"(min-width: 1530px)"},ET.initHeaderMenu=function(){var o=$("html"),t=$(".menu-toggle"),e=document.querySelector(".menu-wrap"),n=$("header .menu > li.menu-item-has-children"),i=$("header .menu a[href]"),r=($("body").on("click",function(t){var e=$(t.target).closest(".menu-wrap");$(t.target).is(".menu-toggle")||$(t.target).closest(".menu-toggle").length||e.length||o.removeClass("menu-active")}),window.scrollY);$(window).on("scroll",throttle(function(){window.scrollY>r&&n.removeClass("hover"),r=window.scrollY},100)),t.on("click",function(){$("header").css({transform:"none"}),o.toggleClass("menu-active"),o.hasClass("menu-active")?(bodyScrollLock.disableBodyScroll(e),$(window).one("resize",function(){o.removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()}),gsap.fromTo("header .menu-header > *, header .menu > li, header .utility > *",{opacity:0,x:100},{opacity:1,x:0,duration:.5,stagger:.025,ease:"power2.out",clearProps:!0})):bodyScrollLock.enableBodyScroll(e)}),gsap.set("header .menu > li > .sub-menu",{height:0}),$(".sub-menu-toggle").on("click",function(){var t=$(this).closest("li"),e=t.find("> .sub-menu"),o=$("ul.menu > li.active").not(t),n=o.find("> .sub-menu");o.removeClass("active"),t.toggleClass("active"),gsap.to(n,{height:0,duration:.5,ease:"power2.out"}),gsap.to(e,{height:t.hasClass("active")?"auto":0,duration:.5,ease:"power2.out"})}),n.on("mouseenter mousemove",function(){$(this).addClass("hover")}),n.on("mouseleave",function(){$(this).removeClass("hover")}),i.on("click",function(t){$(this).trigger("blur"),n.removeClass("hover"),o.removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()})},ET.initHeaderScrollBehavior=function(){var t=$("header");$(window).on("scroll",throttle(function(){t.toggleClass("minify",100<window.scrollY)},50))},ET.initContentScrollTriggers=function(){ScrollTrigger.batch("[data-scroll-fade], [data-scroll-fade-children] > *",{start:"top bottom",end:"bottom top",interval:.125,batchMax:64,onEnter:function(t){gsap.to(t,{opacity:1,y:0,duration:1,ease:"expo.out",stagger:.375/t.length,overwrite:!0})}})},ET.initFitVids=function(){fitvids()},ET.initShareLinks=function(){$("[data-share]").on("click",function(t){t.preventDefault();t=$(this).attr("href");popupwindow(t,"Share",600,460)})},ET.initPopupLinks=function(){$("a.popup, .popup a").on("click",function(){$("html").removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()}),$("a.popup, .popup a").magnificPopup({type:"iframe",mainClass:"mfp-fade",removalDelay:510,closeBtnInside:!1,disableOn:function(){return window.matchMedia(ET.mq.lg).matches}})},ET.getTextStyles=function(t){var t=window.getComputedStyle(t),e=[];return"none"!==t.textTransform&&e.push("<tr><td>Text Transform</td><td>"+t.textTransform+"</td></tr>"),e.push("<tr><td>Font Weight</td><td>"+t.fontWeight+"</td></tr>"),e.push("<tr><td>Font Size</td><td>"+t.fontSize+"</td></tr>"),e.push("<tr><td>Line Height</td><td>"+t.lineHeight+"</td></tr>"),"normal"!==t.fontStyle&&e.push("<tr><td>Font Style</td><td>"+t.fontStyle+"</td></tr>"),"normal"!==t.letterSpacing&&e.push("<tr><td>Letter Spacing</td><td>"+t.letterSpacing+"</td></tr>"),'<table class="table text-blue" style="width: auto;">'+e.join("")+"</table>"},ET.initStyleGuide=function(){function t(){e.each(function(){var t=$(this),e=t.data("text-styles"),e=$(e),e=e.length?ET.getTextStyles(e[0]):"Target not found";e=$(e).append(t.data("children")),t.html(e)})}var e=$("[data-text-styles]");e.each(function(){var t=$(this),e=t.find("tr");t.data("children",e)});$(window).resize(t),t()},ET.initPageHeader=function(){$("section.page-header-large .swiper").each(function(){var t=$(this);new Swiper(t[0],{loop:!0,keyboard:!0,autoplay:{delay:5e3},effect:"fade"})})},ET.initSliders=function(){$(".default-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})}),$(".image-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,slidesPerView:1,spaceBetween:10,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{768:{slidesPerView:3}}})})},ET.initTestimonials=function(){$(".testimonials-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",type:"bullets",clickable:!0}})})},ET.loadPosts=function(t){var e=$(".post-grid"),o=e.find(".posts"),n=$("header");gsap.to(e.find(".posts"),{opacity:0,duration:.25,ease:"power2.in",overwrite:!0,onComplete:function(){$.get(t,function(t){t=$(t).find(".post-grid .posts");o.after(t).remove(),$(".pagination a").attr("data-no-swup",""),ET.initContentScrollTriggers()})}}),e[0].getBoundingClientRect().top<0&&window.scrollTo({top:e.offset().top-n.outerHeight()-100,behavior:"smooth"})},ET.initPostFilters=function(){var e,o=$("form.post-filter"),t=$("form.preset-filter"),n=o.attr("action");o.length&&(t.length&&(e=o.serialize(),ET.loadPosts(n+"?"+e)),n=n.replace(window.location.protocol+"//","").replace(window.location.hostname,""),o.on("submit",function(t){t.preventDefault(),e=o.serialize(),ET.loadPosts(n+"?"+e)}))},ET.initPostFiltersReset=function(){var e,t=$("form.post-filter"),o=t.find(".reset-filters");o.length&&(e=t.find('input[type="text"], select'),t.on("submit",function(){var t=!1;e.each(function(){$(this).val()&&(t=!0)}),gsap.to(o,{opacity:t?1:0,duration:.25,onComplete:function(){o.prop("disabled",!t)}})}),o.on("click",function(){e.val(""),t.find("select[multiple]").trigger("change"),t.trigger("submit")}))},ET.initPostFiltersPagination=function(){var t=$("section.post-grid"),e=$("form.post-filter"),o=e.find('input[name="posts_per_page"]');o.length&&t.on("change",'select[name="posts_per_page"]',function(){var t=$(this).val();o.val(t),e.trigger("submit")})},ET.initPagination=function(){var t=$("section.post-grid");t.length&&($(".pagination a").attr("data-no-swup",""),t.on("click",".pagination a",function(t){t.preventDefault();t=$(this).attr("href");ET.loadPosts(t)}))},ET.initFAQs=function(){var t=$("section.faqs");t.length&&t.find("dt").on("click",function(){$(this).toggleClass("active")})},ET.initBanners=function(){var t=$("section.banner-image");t.length&&t.each(function(){var t=$(this);gsap.to(t.find("picture"),{yPercent:20,ease:"none",scrollTrigger:{trigger:t,start:"top bottom",end:"bottom top",scrub:!0}})})},ET.initFooterCTA=function(){var n,i,r,a,t,e=$("section.footer-cta");e.length&&(n=e.find("h1"),i=e.find("svg.footer-cta-path-1"),e.find("svg.footer-cta-path-1 path"),r=e.find("svg.footer-cta-path-2"),a=e.find("svg.footer-cta-path-2 path"),e=e.find(".btn"),t=new SplitText(n,{type:"words"}),new gsap.timeline({scrollTrigger:{trigger:i,start:"top 90%"}}).from(t.words,{duration:1,x:-100,autoAlpha:0,stagger:.015,ease:"power2.out"}),(t=new gsap.timeline({scrollTrigger:{trigger:r,start:"top 90%"}})).from(a,{drawSVG:0,duration:3,ease:"power2.out"},0),t.from(e,{opacity:0,scale:.75,x:-40,duration:1,ease:"back.out"},.85),t=function(){var t=n[0].getBoundingClientRect(),e=t.x-16,o=r[0].getBoundingClientRect(),t=t.x+t.width-o.x,o=8*(1e3/t);i.width(e),r.width(t),d2Formatted="M0,0 L{0},0 C{1},0 500,{2} 500,{3} L500,{4} C500,{5} {6},100 {7},100 L1000,100".replace("{0}",500-2*o).replace("{1}",500-o).replace("{2}",7.2).replace("{3}",16).replace("{4}",84).replace("{5}",92).replace("{6}",500+.9*o).replace("{7}",500+2*o),a.attr("d",d2Formatted)},$(window).on("load resize",throttle(t,100)),t())},ET.initTimeline=function(){$(".timeline").length&&ScrollTrigger.matchMedia({"(min-width: 768px)":function(){$(".milestone").each(function(){var t=$(this),e=t.find(".image"),o=t.hasClass("even");gsap.fromTo(e,{yPercent:o?100:50},{yPercent:o?-100:-50,ease:"none",scrollTrigger:{trigger:t,start:"top bottom",end:"bottom top",scrub:1}})})}})},ET.getInfoWindowContent=function(t){var e=t.getProperty("title"),o=t.getProperty("url"),t=t.getProperty("description"),n='<a href="$url" target="_blank" rel="noopener noreferrer"><strong>$title</strong></a><br/>'.replace("$url",o).replace("$title",e),i="<strong>$title</strong><br/>".replace("$title",e);return[o&&e?n:"",!o&&e?i:"",t].join("")},ET.initMapEmbed=function(){var l,c,t,d,e=$("main.map-embed");e.length&&(t=e.find(".map")[0],l=new google.maps.Map(t,{center:{lat:47.6469,lng:-122.1753},zoom:12,maxZoom:18,mapId:"9f1e644298b32b70"}),(ET.map=l).addListener("isfractionalzoomenabled_changed",function(){l.fitBounds({south:47.498949,west:-122.304718,north:47.794493,east:-122.045891})}),t=e.data("geojson"),l.data.loadGeoJson(t),l.data.setStyle(function(t){return{fillColor:91<t.getProperty("ascii")?"red":"blue",strokeWeight:1}}),l.data.setStyle(function(t){var e=t.getProperty("marker-color")||"blue";return{zIndex:t.getProperty("zIndex")||1,strokeColor:t.getProperty("stroke"),strokeWeight:t.getProperty("strokeWeight")||4,icon:[ET.template_directory_url,"/static/img/map-marker-",t.getProperty("marker-symbol"),"-",e,".svg"].join("")}}),c=new google.maps.InfoWindow({maxWidth:400}),l.data.addListener("click",function(t){var e=ET.getInfoWindowContent(t.feature);e&&(void 0!==t.feature.getGeometry().get?c.setOptions({pixelOffset:new google.maps.Size(0,-32)}):void 0!==t.feature.getGeometry().getLength&&c.setOptions({pixelOffset:new google.maps.Size(0,0)}),c.setContent(e),c.setPosition(t.latLng),c.open(l))}),t=e.find("button.expand"),d=e.find(".layers"),t.on("click",function(){d.toggleClass("active")}),e.find(".group-layer").on("click",function(t){$(t.target).is("button")||$(t.target).closest("button").length||$(this).closest("li").find("ul").slideToggle()}),e.find(".visibility").on("click",function(t){$(this).closest("li").toggleClass("hidden");var e=$(this).closest(".group-layer").data("group"),o=!$(this).closest("li").hasClass("hidden");l.data.forEach(function(t){t.getProperty("group")===e&&l.data.overrideStyle(t,{visible:o})})}),e.find(".feature-layer").on("click",function(t){var e,o,n,i,r,a,s=$(this).data("feature");d.removeClass("active"),l.data.forEach(function(t){t.getProperty("id")===s&&(e=t)}),e?(o=e.getProperty("group"),$('.group-layer[data-group="'+o+'"]').closest("li").removeClass("hidden"),l.data.forEach(function(t){t.getProperty("group")===o&&l.data.overrideStyle(t,{visible:!0})}),n=new google.maps.LatLngBounds,e.getGeometry().forEachLatLng(function(t){n.extend(t)}),l.fitBounds(n),i=ET.getInfoWindowContent(e),"Eastrail System"===e.getProperty("title")?c.close():i&&(void 0!==e.getGeometry().get?(a=e.getGeometry().get(),c.setOptions({pixelOffset:new google.maps.Size(0,-32)})):void 0!==e.getGeometry().getLength&&(r=e.getGeometry().getLength(),a=e.getGeometry().getAt(Math.floor(r/2)),c.setOptions({pixelOffset:new google.maps.Size(0,0)})),c.setContent(i),c.setPosition(a),c.open(l))):console.error("Feature with ID "+s+" not found.")}))},ET.initDonationNonce=function(){$("#wc-donation-frontend-script-js-extra").length&&"undefined"!=typeof wcOrderScript&&void 0!==wcOrderScript.donationToOrder&&void 0!==wcOrderScript.donationToOrder.nonce&&$.get(ET.ajaxurl+"?action=get_donation_nonce",function(t){t.success?(t=t.data.nonce,wcOrderScript.donationToOrder.nonce=t):console.error("Error fetching donation nonce")})},$(document).ready(function(){ET.initHeaderMenu(),ET.initHeaderScrollBehavior(),ET.initContentScrollTriggers(),ET.initFitVids(),ET.initShareLinks(),ET.initPopupLinks(),ET.initStyleGuide(),ET.initPageHeader(),ET.initSliders(),ET.initTestimonials(),ET.initPostFilters(),ET.initPostFiltersReset(),ET.initPostFiltersPagination(),ET.initPagination(),ET.initFAQs(),ET.initBanners(),ET.initTimeline(),ET.initDonationNonce()}),$(window).on("load",function(){ET.initFooterCTA()});