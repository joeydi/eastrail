...
var $=$||jQuery,ET=ET||{};gsap.registerPlugin(DrawSVGPlugin,ScrollTrigger,SplitText),ET.mq={xs:"(min-width: 375px)",sm:"(min-width: 576px)",md:"(min-width: 768px)",lg:"(min-width: 992px)",xl:"(min-width: 1200px)",xxl:"(min-width: 1530px)"},ET.initHeaderMenu=function(){var i=$("html"),t=$(".menu-toggle"),e=document.querySelector(".menu-wrap"),o=$("header .menu > li.menu-item-has-children"),n=$("header .menu a[href]"),r=($("body").on("click",function(t){var e=$(t.target).closest(".menu-wrap");$(t.target).is(".menu-toggle")||$(t.target).closest(".menu-toggle").length||e.length||i.removeClass("menu-active")}),window.scrollY);$(window).on("scroll",throttle(function(){window.scrollY>r&&o.removeClass("hover"),r=window.scrollY},100)),t.on("click",function(){$("header").css({transform:"none"}),i.toggleClass("menu-active"),i.hasClass("menu-active")?(bodyScrollLock.disableBodyScroll(e),$(window).one("resize",function(){i.removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()}),gsap.fromTo("header .menu-header > *, header .menu > li, header .utility > *",{opacity:0,x:100},{opacity:1,x:0,duration:.5,stagger:.025,ease:"power2.out",clearProps:!0})):bodyScrollLock.enableBodyScroll(e)}),gsap.set("header .menu > li > .sub-menu",{height:0}),$(".sub-menu-toggle").on("click",function(){var t=$(this).closest("li"),e=t.find("> .sub-menu"),i=$("ul.menu > li.active").not(t),o=i.find("> .sub-menu");i.removeClass("active"),t.toggleClass("active"),gsap.to(o,{height:0,duration:.5,ease:"power2.out"}),gsap.to(e,{height:t.hasClass("active")?"auto":0,duration:.5,ease:"power2.out"})}),o.on("mouseenter mousemove",function(){$(this).addClass("hover")}),o.on("mouseleave",function(){$(this).removeClass("hover")}),n.on("click",function(t){$(this).trigger("blur"),o.removeClass("hover"),i.removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()})},ET.initHeaderScrollBehavior=function(){var t=$("header");$(window).on("scroll",throttle(function(){t.toggleClass("minify",100<window.scrollY)},50))},ET.initContentScrollTriggers=function(){ScrollTrigger.batch("[data-scroll-fade], [data-scroll-fade-children] > *",{start:"top bottom",end:"bottom top",interval:.125,batchMax:64,onEnter:function(t){gsap.to(t,{opacity:1,y:0,duration:1,ease:"expo.out",stagger:.375/t.length,overwrite:!0})}})},ET.initFitVids=function(){fitvids()},ET.initShareLinks=function(){$("[data-share]").on("click",function(t){t.preventDefault();t=$(this).attr("href");popupwindow(t,"Share",600,460)})},ET.initPopupLinks=function(){$("a.popup, .popup a").on("click",function(){$("html").removeClass("menu-active"),bodyScrollLock.clearAllBodyScrollLocks()}),$("a.popup, .popup a").magnificPopup({type:"iframe",mainClass:"mfp-fade",removalDelay:510,closeBtnInside:!1,disableOn:function(){return window.matchMedia(ET.mq.lg).matches}})},ET.getTextStyles=function(t){var t=window.getComputedStyle(t),e=[];return"none"!==t.textTransform&&e.push("<tr><td>Text Transform</td><td>"+t.textTransform+"</td></tr>"),e.push("<tr><td>Font Weight</td><td>"+t.fontWeight+"</td></tr>"),e.push("<tr><td>Font Size</td><td>"+t.fontSize+"</td></tr>"),e.push("<tr><td>Line Height</td><td>"+t.lineHeight+"</td></tr>"),"normal"!==t.fontStyle&&e.push("<tr><td>Font Style</td><td>"+t.fontStyle+"</td></tr>"),"normal"!==t.letterSpacing&&e.push("<tr><td>Letter Spacing</td><td>"+t.letterSpacing+"</td></tr>"),'<table class="table text-blue" style="width: auto;">'+e.join("")+"</table>"},ET.initStyleGuide=function(){function t(){e.each(function(){var t=$(this),e=t.data("text-styles"),e=$(e),e=e.length?ET.getTextStyles(e[0]):"Target not found";e=$(e).append(t.data("children")),t.html(e)})}var e=$("[data-text-styles]");e.each(function(){var t=$(this),e=t.find("tr");t.data("children",e)});$(window).resize(t),t()},ET.initPageHeader=function(){$("section.page-header-large .swiper").each(function(){var t=$(this);new Swiper(t[0],{loop:!0,keyboard:!0,autoplay:{delay:5e3},effect:"fade"})})},ET.initSliders=function(){$(".default-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}})}),$(".image-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,slidesPerView:1,spaceBetween:10,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{768:{slidesPerView:3}}})})},ET.initTestimonials=function(){$(".testimonials-slider").each(function(){var t=$(this);new Swiper(t[0],{autoHeight:!0,loop:!0,keyboard:!0,mousewheel:{forceToAxis:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",type:"bullets",clickable:!0}})})},ET.loadPosts=function(t){var e=$(".post-grid"),i=e.find(".posts"),o=$("header");gsap.to(e.find(".posts"),{opacity:0,duration:.25,ease:"power2.in",overwrite:!0,onComplete:function(){$.get(t,function(t){t=$(t).find(".post-grid .posts");i.after(t).remove(),$(".pagination a").attr("data-no-swup",""),ET.initContentScrollTriggers()})}}),e[0].getBoundingClientRect().top<0&&window.scrollTo({top:e.offset().top-o.outerHeight()-100,behavior:"smooth"})},ET.initPostFilters=function(){var e,i=$("form.post-filter"),t=$("form.preset-filter"),o=i.attr("action");i.length&&(t.length&&(e=i.serialize(),ET.loadPosts(o+"?"+e)),o=o.replace(window.location.protocol+"//","").replace(window.location.hostname,""),i.on("submit",function(t){t.preventDefault(),e=i.serialize(),ET.loadPosts(o+"?"+e)}))},ET.initPostFiltersReset=function(){var e,t=$("form.post-filter"),i=t.find(".reset-filters");i.length&&(e=t.find('input[type="text"], select'),t.on("submit",function(){var t=!1;e.each(function(){$(this).val()&&(t=!0)}),gsap.to(i,{opacity:t?1:0,duration:.25,onComplete:function(){i.prop("disabled",!t)}})}),i.on("click",function(){e.val(""),t.find("select[multiple]").trigger("change"),t.trigger("submit")}))},ET.initPostFiltersPagination=function(){var t=$("section.post-grid"),e=$("form.post-filter"),i=e.find('input[name="posts_per_page"]');i.length&&t.on("change",'select[name="posts_per_page"]',function(){var t=$(this).val();i.val(t),e.trigger("submit")})},ET.initPagination=function(){var t=$("section.post-grid");t.length&&($(".pagination a").attr("data-no-swup",""),t.on("click",".pagination a",function(t){t.preventDefault();t=$(this).attr("href");ET.loadPosts(t)}))},ET.initFAQs=function(){var t=$("section.faqs");t.length&&t.find("dt").on("click",function(){$(this).toggleClass("active")})},ET.initBanners=function(){var t=$("section.banner-image");t.length&&t.each(function(){var t=$(this);gsap.to(t.find("picture"),{yPercent:20,ease:"none",scrollTrigger:{trigger:t,start:"top bottom",end:"bottom top",scrub:!0}})})},ET.initFooterCTA=function(){var o,n,r,a,t,e=$("section.footer-cta");e.length&&(o=e.find("h1"),n=e.find("svg.footer-cta-path-1"),e.find("svg.footer-cta-path-1 path"),r=e.find("svg.footer-cta-path-2"),a=e.find("svg.footer-cta-path-2 path"),e=e.find(".btn"),t=new SplitText(o,{type:"words"}),new gsap.timeline({scrollTrigger:{trigger:n,start:"top 90%"}}).from(t.words,{duration:1,x:-100,autoAlpha:0,stagger:.015,ease:"power2.out"}),(t=new gsap.timeline({scrollTrigger:{trigger:r,start:"top 90%"}})).from(a,{drawSVG:0,duration:3,ease:"power2.out"},0),t.from(e,{opacity:0,scale:.75,x:-40,duration:1,ease:"back.out"},.85),t=function(){var t=o[0].getBoundingClientRect(),e=t.x-16,i=r[0].getBoundingClientRect(),t=t.x+t.width-i.x,i=8*(1e3/t);n.width(e),r.width(t),d2Formatted="M0,0 L{0},0 C{1},0 500,{2} 500,{3} L500,{4} C500,{5} {6},100 {7},100 L1000,100".replace("{0}",500-2*i).replace("{1}",500-i).replace("{2}",7.2).replace("{3}",16).replace("{4}",84).replace("{5}",92).replace("{6}",500+.9*i).replace("{7}",500+2*i),a.attr("d",d2Formatted)},$(window).on("load resize",throttle(t,100)),t())},ET.initTimeline=function(){$(".timeline").length&&ScrollTrigger.matchMedia({"(min-width: 768px)":function(){$(".milestone").each(function(){var t=$(this),e=t.find(".image"),i=t.hasClass("even");gsap.fromTo(e,{yPercent:i?100:50},{yPercent:i?-100:-50,ease:"none",scrollTrigger:{trigger:t,start:"top bottom",end:"bottom top",scrub:1}})})}})},ET.initMapEmbed=function(){var i,n,o,t,e,r=$("main.map-embed");r.length&&(i=new google.maps.InfoWindow,e=r.find(".map")[0],t={center:{lat:47.63,lng:-122.18},zoom:12,maxZoom:18,mapTypeId:google.maps.MapTypeId.ROADMAP},n=new google.maps.Map(e,t),ET.map=n,e=r.data("geojson"),n.data.loadGeoJson(e),n.data.setStyle(function(t){return{fillColor:91<t.getProperty("ascii")?"red":"blue",strokeWeight:1}}),o={133408389:"blue",752318534:"blue",499410108:"blue",2333824518:"blue",1160417020:"red",3979213705:"blue",603738419:"blue"},n.data.setStyle(function(t){var e=t.getProperty("group");return{strokeColor:t.getProperty("stroke"),strokeWeight:4,icon:[ET.template_directory_url,"/static/img/map-marker-",t.getProperty("marker-symbol"),"-",o[e],".svg"].join("")}}),n.data.addListener("click",function(t){var e=t.feature.getProperty("title"),e=[e?"<strong>"+e+"</strong><br/>":"",t.feature.getProperty("description")].join("");i.setContent(e),i.setPosition(t.latLng),i.setOptions({pixelOffset:new google.maps.Size(0,-32)}),i.open(n)}),t=r.find(".group-layer"),e=r.find(".feature-layer"),r=r.find(".visibility"),t.on("click",function(t){$(t.target).is("button")||$(t.target).closest("button").length||$(this).closest("li").find("ul").slideToggle()}),e.on("click",function(t){var e,i=$(this).data("feature"),o=n.data.getFeatureById(i);o?(e=new google.maps.LatLngBounds,o.getGeometry().forEachLatLng(function(t){e.extend(t)}),n.fitBounds(e)):console.error("Feature with ID "+i+" not found.")}),r.on("click",function(t){$(this).closest("li").toggleClass("hidden")}))},$(document).ready(function(){ET.initHeaderMenu(),ET.initHeaderScrollBehavior(),ET.initContentScrollTriggers(),ET.initFitVids(),ET.initShareLinks(),ET.initPopupLinks(),ET.initStyleGuide(),ET.initPageHeader(),ET.initSliders(),ET.initTestimonials(),ET.initPostFilters(),ET.initPostFiltersReset(),ET.initPostFiltersPagination(),ET.initPagination(),ET.initFAQs(),ET.initBanners(),ET.initTimeline()}),$(window).on("load",function(){ET.initFooterCTA()});